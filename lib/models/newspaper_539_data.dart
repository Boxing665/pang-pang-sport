...
const newspaper539Data = <String, Newspaper539Entry>{
  ...
  '05/25': Newspaper539Entry(
    ...
    bagua: [07, 27, 37],
    banlu: [02, 12, 32],
    toucai1: [09, 15, 24, 28, 39],
    toucai2: [04, 18, 20, 29, 34],
  ),

  // ── 2026/05/26（星期二）─────────────────────────────────────
  '05/26': Newspaper539Entry(
    date: '05/26',
    guZhi: 11,
    erZhong: [28, 33],
    sanZhong: [05, 10, 39],
    ...
    bagua: [02, 22, 32],
    banlu: [03, 13, 23],
    toucai1: [02, 15, 20, 25, 36],
    toucai2: [09, 14, 19, 26, 34],
  ),

  // ── 2026/05/27（星期三）─────────────────────────────────────
  '05/27': Newspaper539Entry(
    date: '05/27',
    guZhi: 36,
    erZhong: [21, 23],
    sanZhong: [12, 28, 32],
    ...
    bagua: [06, 16, 26],
    banlu: [01, 11, 31],
    toucai1: [08, 13, 20, 23, 34],
    toucai2: [04, 10, 29, 33, 38],
  ),

  // ── 2026/05/28（星期四）─────────────────────────────────────
  '05/28': Newspaper539Entry(
    date: '05/28',
    guZhi: 36,
    erZhong: [23, 32],
    sanZhong: [07, 15, 28],
    ...
    bagua: [05, 25, 35],
    banlu: [02, 12, 22],
    toucai1: [04, 17, 18, 20, 34],
    toucai2: [07, 19, 27, 30, 39],
  ),

  // ── 2026/05/29（星期五）─────────────────────────────────────
  '05/29': Newspaper539Entry(
    date: '05/29',
    guZhi: 31,
    erZhong: [15, 24],
    sanZhong: [13, 19, 27],
    ...
    bagua: [04, 14, 34],
    banlu: [07, 17, 37],
    toucai1: [05, 10, 18, 29, 38],
    toucai2: [08, 12, 21, 30, 39],
  ),

  // ── 2026/05/30（星期六）─────────────────────────────────────
  '05/30': Newspaper539Entry(
    date: '05/30',
    guZhi: 23,
    erZhong: [36, 39],
    sanZhong: [07, 14, 32],
    ...
    bagua: [18, 28, 38],
    banlu: [03, 13, 33],
    toucai1: [09, 10, 12, 24, 37],
    toucai2: [04, 19, 22, 27, 34],
  ),
};
